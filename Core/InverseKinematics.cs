...
public class Limb
{
    ...
    /// The segments follow each other using <a href="https://en.wikipedia.org/wiki/Inverse_kinematics">inverse kinematics</a>.
    /// </summary>
    ...
    {
        foreach (Bone segment in _segments)
        {
            segment.Draw(_texture, color);
        }
    }
}